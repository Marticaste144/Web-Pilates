...
// Mismo patrón que ProfesorTopbar/AdminTopbar: nombre real + desplegable
// con "Cerrar sesión", sin botón independiente en ningún lado.
export function AlumnoTopbar({ nombre, apellido }: { nombre: string; apellido: string }) {
