...
// Mismo patrón que ProfesorTopbar: sin datos del admin en el sidebar, todo
// vive acá arriba en el desplegable (nombre real + cerrar sesión).
export function AdminTopbar({ nombre, apellido }: { nombre: string; apellido: string }) {
