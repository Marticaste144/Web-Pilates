...
import { HomeIcon, UsersIcon, UserIcon, CalendarIcon, TagIcon, MegaphoneIcon, ImageIcon } from "@/components/ui/icons";
...
// Mismo shell visual que el profesor (ProfesorSidebar): sidebar angosto con
// degradé azul -> turquesa y formas orgánicas de fondo en desktop, tab bar
// inferior en mobile -- así ambos roles se sienten parte del mismo sistema.
